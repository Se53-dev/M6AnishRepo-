...
/**
 * this method helps to slove Synchronization
 * @param d
 * @param time
 */
...
/**
 * this method helps to release a particular element
 * @param d
 * @param ele
 */
...
/**
 * this method helps to Deselect options from Dropdown by index
 * @param d
 * @param ele
 * @param index
 */
...
/**
 *this method helps to Deselect option from Dropdown by visible text 
 * @param d
 * @param ele
 * @param text
 */
...
/**
 * this methods helps to pass message to Alert popup
 * @param d
 * @param msg
 */
 ...
 * @param value
 */
public void operationWithJs(WebDriver d, String value)
{
